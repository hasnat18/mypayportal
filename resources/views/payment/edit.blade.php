                                    ...
                                    <div class="form-row mb-4">
                                            ...
                                            <select class="form-control" id="gateway_id" name="gateway_id">
                                                @foreach ($gateways as $gateway)
                                                    <option value="{{ $gateway->id }}"
                                                        {{ $payment->gateway_id == $gateway->id ? 'selected' : '' }}>
                                                        {{ $gateway->name }}</option>
                                                @endforeach
                                            </select>
                                            <span class="text-danger error-message" id="gateway_id_error"></span>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="invoice_number"
                                                ...
                                                value="{{ $payment->invoice_number }}" readonly>
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="package_name" name="package_name"
                                                placeholder="Package Name" value="{{ $payment->package_name }}">
                                            <span class="text-danger error-message" id="package_name_error"></span>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="description">Description</label>
                                            <input type="text" class="form-control" id="description" name="description"
                                                placeholder="Description" value="{{ $payment->description }}">
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" id="currency" name="currency">
                                                <option {{ $payment->currency == 'usd' ? 'selected' : '' }} value="usd"
                                                    selected>USD</option>
                                                <option {{ $payment->currency == 'gbp' ? 'selected' : '' }} value="gbp">
                                                    GBP</option>
                                            </select>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control" id="price" name="price"
                                                placeholder="Tax" value="{{ $payment->price }}">
                                    ...
                                    <div class="form-row mb-4">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control" id="tax" name="tax"
                                                placeholder="Tax" value="{{ $payment->tax }}">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" class="form-control" id="remaining" name="remaining"
                                                placeholder="Remaining" value="{{ $payment->remaining }}">
