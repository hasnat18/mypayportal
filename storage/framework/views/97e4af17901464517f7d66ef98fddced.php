                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php echo e($payment->tax); ?></td>
                                    <td>
                                        <?php echo e($payment->currency == 'usd' ? '$' : ''); ?>

                                        <?php echo e($payment->currency == 'gbp' ? '£' : ''); ?>

                                        <?php echo e($payment->remaining); ?>
                                    ...
                                    <td>
                                        ...
                                        <?php echo e($payment->tax + $payment->price); ?>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="/invoice/<?php echo e($payment->invoice_number); ?>" class="btn btn-sm btn-outline-primary">
                                            ...
                                            <a href="<?php echo e(url('/proceed/'.$payment->invoice_number)); ?>" class="btn btn-sm btn-outline-dark copyLink" data-invoice="<?php echo e($payment->invoice_number); ?>">
                                            ...
                                            <a href="<?php echo e(route('payments.edit', $payment->id)); ?>" class="btn btn-sm btn-outline-warning ">
