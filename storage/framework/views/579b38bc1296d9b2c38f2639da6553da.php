                            ...
                            <form id="editGatewayForm">
                                <div class="form-row mb-4">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input value="<?php echo e($gateway->name); ?>" type="text" class="form-control" id="name" name="name" placeholder="First Name">
                                ...
                                <div class="form-row mb-4">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input value="<?php echo e($gateway->key1); ?>" type="text" class="form-control" id="key1" name="key1" placeholder="First Name">
                                ...
                                <div class="form-row mb-4">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input value="<?php echo e($gateway->key2); ?>" type="text" class="form-control" id="key2" name="key2" placeholder="First Name">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Hasnat Khan\Desktop\mypayportal\mypayportal\resources\views\gateway\edit.blade.php ENDPATH**/ ?>